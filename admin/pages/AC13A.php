    ...
    <h2>Ajouter une Etape</h2>
      ...
      <div class="container">
        <div class="row">
          <div class="col">
           <div class="box1">
            <p class="full-width-borders">AC13 - Ajouter une Etape - Tournée <?php echo $_POST [ 'tournee' ] ; ?> Etape <?php echo $_POST [ 'etape' ] ; ?> </p>
        		<form action="../admin/pages/AC13traitementA.php" method="post">
              ...
              <input id="RDVPrise" class="form-control" name="prisEnCharge" type="datetime-local" value="<?php $date = date("Y/m/d H:i:00"); echo "$date" ?>" readonly size="10" maxlength="8"/>

...
<nav class="light-green">
    <div class="container">
        <div class="nav-wrapper">
            <a href="index.php?page=home" class="brand-logo">FetchMotion Administration</a>
            <?php
            if($page != 'login' && $page != 'new' && $page != 'password'){
                ?>
                    ...
                    <ul class="side-nav" id="mobile-menu">
                        ...
                        if(admin()==1){
                            ?>
                                <li class="<?php echo ($page=="write")?"active" : ""; ?>"><a href="index.php?page=write">Importer CSV</a></li>
